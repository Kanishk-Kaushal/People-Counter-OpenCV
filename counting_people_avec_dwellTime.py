    ...
    for (objectID, centroid) in objects.items():
        ...
        # to determine direction
            ...
            if not to.counted:
                ...
                avg_dwellTime = dwell_time[1]
                #print("Average Dwell Time: ", avg_dwellTime)
    ...
    for (i, (k, v)) in enumerate(info):
        ...
        if k == 'Down':
            cv.putText(frame, f'Down : {text}', (10, 75),
                       cv.FONT_HERSHEY_SIMPLEX, 0.6, (0, 0, 255), 2)
        if k == 'Total':
            cv.putText(frame, f'Total : {text}', (10, 95),
                       cv.FONT_HERSHEY_SIMPLEX, 0.6, (0, 0, 255), 2)
        if k == 'DwellTime':
            cv.putText(frame, f'DwellTime : {text}', (10, 115),
                       cv.FONT_HERSHEY_SIMPLEX, 0.6, (0, 0, 255), 2)
# Process inputs
